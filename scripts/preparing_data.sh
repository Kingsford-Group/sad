	...
	for n in ${NumEvents[@]}; do
		for ((j=0; j<${#RefQuantPrefix[@]}; j++)); do
			...
			if [[ ! -e simu_${t}_${ID}_${n}_theoexp.txt ]]; then
				...
				python3 /mnt/disk33/user/congm1/Code/SAD/src/Simulation.py ${transfasta} ${gtffile} ${refquantfile} simu_${t}_${ID}_${n} ${n} ${n}
			fi
			...
			if [[ ! -e groundtruth_${t}_${ID}_${n}/removelist_noveljunc.txt ]]; then
				...
				/home/congm1/savanna/savannacong33/Code/SAD/bin/categorizesimulation ${gtffile} simu_${t}_${ID}_${n}_removelist.txt simu_${t}_${ID}_${n}_target.fa groundtruth_${t}_${ID}_${n}/
			fi
