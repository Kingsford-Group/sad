...
MetaFile="${codedir}/../data/HumanBodyMap/HumanBodyMap_SRR_Acc_List.txt"
...
#for ((i=0; i<${#Type[@]}; i++)); do
	...
	while read -r line; do
		...
		if [[ -e ${OutDirectory}/salmon_${t}_${ID}/${SADFolder}/sad_pvalue_overall ]] && [[ ! -e ${OutDirectory}/salmon_${t}_${ID}/${SADFolder}/sad_pvalue_overall_sorted_uniqgene ]]; then
			...
			python3 ${codedir}/AdjustPValue.py 1 ${OutDirectory}/salmon_${t}_${ID}/${SADFolder}/sad_pvalue_overall ${OutDirectory}/salmon_${t}_${ID}/${SADFolder}/sad_pvalue_overall_sorted
