...
MetaFile="/home/congm1/savanna/savannacong33/RawData/HumanBodyMap/HumanBodyMap_SRR_Acc_List.txt"
...
ReadFolder="/home/congm1/savanna/savannacong33/RawData/HumanBodyMap"

OutDirectory="/home/congm1/savanna/savannacong33/SADrealdata/HumanBodyMap"
...
#for ((i=0; i<${#Type[@]}; i++)); do
	...
	while read -r line; do
		...
		#if [[ -e ${OutDirectory}/salmon_${t}_${ID}/${SADFolder}/test_pvalue_overall_sorted_uniqgene ]] && [[ ! -e ${OutDirectory}/salmon_${t}_${ID}/${SADFolder}/test_pvalue_overall_sorted_uniqgene_append ]]; then
